const Hero4 = () => {
  return (
    <div className="mt-40">
      <h3 className="text-orange-500 mb-8 flex justify-start px-20">Practice Advice</h3>
      <h3 className="font-bold text-3xl flex justify-start px-20 mb-4">Approdable Packages</h3>
       <div>
        <h3 className="flex justify-start px-20">Problems trying to resolve the conflict between</h3>
